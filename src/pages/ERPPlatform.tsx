...
const MapVisualization: React.FC = () => {
  ...
  const mapData = {
    ...
    emergencies: [
      { id: 'em001', type: 'fire', location: '生产厂区A区1号车间', status: 'active', level: 'high', x: 250, y: 200, time: '2024-01-15 14:30' },
      { id: 'em002', type: 'equipment', location: '生产厂区B区仓库', status: 'investigating', level: 'medium', x: 450, y: 320, time: '2024-01-15 15:15' },
      { id: 'em003', type: 'safety', location: '研发楼实验室', status: 'resolved', level: 'low', x: 650, y: 180, time: '2024-01-15 13:45' }
    ]
  };
...
const ComprehensiveManagement: React.FC<{ setActiveTab: (tab: string) => void }> = ({ setActiveTab }) => {
  ...
  useEffect(() => {
    ...
    // 模拟告警数据
    setAlertData([
      { id: 1, type: 'error', message: '设备离线警告', time: '2024-01-15 14:30', level: 'high' },
      { id: 2, type: 'warning', message: '人员未到岗', time: '2024-01-15 14:25', level: 'medium' },
      { id: 3, type: 'info', message: '任务即将到期', time: '2024-01-15 14:20', level: 'low' }
    ]);

    // 模拟最近活动
    setRecentActivities([
      { id: 1, user: '张伟民', action: '完成了设备维护任务', time: '2024-01-15 14:30' },
      { id: 2, user: '陈志远', action: '创建了新的研发项目', time: '2024-01-15 14:25' },
      { id: 3, user: '刘营销', action: '更新了客户信息', time: '2024-01-15 14:20' },
      { id: 4, user: '马安全', action: '处理了安全事件', time: '2024-01-15 14:15' },
      { id: 5, user: '孙人力', action: '审核了员工申请', time: '2024-01-15 14:10' }
    ]);
  }, []);
...
const ERPPlatform: React.FC = () => {
  ...
  const handleNotifications = () => {
    Modal.info({
      ...
      content: (
        <div>
          <p>• 设备离线警告 (2024-01-15 14:30)</p>
          <p>• 人员未到岗提醒 (2024-01-15 14:25)</p>
          <p>• 任务即将到期 (2024-01-15 14:20)</p>
        </div>
      ),
      onOk() {},
    });
